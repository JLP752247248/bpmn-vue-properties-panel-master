...
import propertiesProvider1Module from './properties-panel-extension/provider/roleinfo'

import authorityModdleDescriptor from './properties-panel-extension/descriptors/authority'
import roleModdleDescriptor from './properties-panel-extension/descriptors/role'
    ...
    init() {
      ...
      this.bpmnModeler = new BpmnModeler({
        ...
        additionalModules: [
          ...
          // 自定义右边工作栏的内容
          propertiesProvider1Module
        ],
        moddleExtensions: {
          camunda: camundaModdleDescriptor,
          role: roleModdleDescriptor
        }
      })
